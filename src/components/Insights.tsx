...
export function Insights() {
  ...
  return (
    <div className="bg-slate-900 rounded-2xl shadow-sm border border-slate-800 p-5 md:p-6 flex flex-col gap-5 text-slate-100">
          ...
          <div className="flex flex-col gap-3">
             {insights.map((insight, idx) => (
                <motion.div 
                   ...
                   className="flex gap-3 bg-slate-800/50 p-4 rounded-xl border border-slate-700/50"
                >
                   <div className="w-6 h-6 rounded-full bg-purple-500/20 text-purple-300 flex items-center justify-center shrink-0 text-xs font-bold font-mono mt-0.5">
                      {idx + 1}
                   </div>
